...
# l = ['мадам','мадам', 'топот', 'топот', 'test', 'madam', 'word']
# polindroms = [word for word in l if word == word[::-1]]
#
# print(polindroms)
#
#
# m = ['Око за око', 'А роза упала на лапу Азора', 'Около Миши молоко']
# polindrom = []
# for word1 in m:
#     word_r = word1.replace(' ', '').lower()
#     if word_r == word_r[::-1]:
#         polindrom.append(word1)
# print(polindrom)
